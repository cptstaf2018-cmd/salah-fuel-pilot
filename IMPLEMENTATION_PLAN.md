...
حالة التنفيذ: مكتمل. الموظف يمسح رمز QR بكاميرا هاتفه فيُخصم المخزون وتُسجَّل
العملية باسمه ووقتها وكميتها. المسح المزدوج وسحب مخزون غير متوفر يفشلان بكتابة
شرطية داخل معاملة واحدة، ومدة منع التكرار (cooldownHours) تُفحص عند التخصيص وعند
المضخة معاً. نتيجة التجهيز تظهر في لوحة السوبر أدمن ولوحة المحطة وصفحة المواطن.

المتبقي من هذه المرحلة: إدخال رقم اللوحة يدوياً كبديل عن QR، وخطوتا «بدء التجهيز»
ثم «تأكيد الاكتمال» المنفصلتان.
